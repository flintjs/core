![flintjs_banner](https://fluxerusercontent.com/attachments/1488572178335257275/1488572548499378933/flint.js-banner.png)
...
| Package | Description |
|---|---|
| `@flint.js/core` | The core framework to start building your bot |
| `@flint.js/cli` | A CLI tool to create new flint.js projects |
| `@flint.js/logger` | Beautifully opinionated logs to integrate into your bot |
...
- [`@fluxerjs/core`](https://npmjs.com/package/@fluxerjs/core)

---

## First Release
We currently have no ETA of an official package release, but we're hoping within a few weeks! Keep an eye on this org and the [@flintjs/core](https://github.com/flintjs/core) repo for updates, or join our official flint.js [Fluxer community](https://fluxer.gg/tBLCu8tN) to get notified when there's an update.
