...
export const FlintClientEvents = {
...
export type FlintClientEventsType = typeof FlintClientEvents[keyof typeof FlintClientEvents]
...
export interface FlintEvents {
    ...
    [FlintClientEvents.CommandSuccess]: [payload: {
        ctx: CommandContext
    }]
    [FlintClientEvents.CommandNotFound]: [payload: {
        prefix: string
        name: string
        message: Message
    }]
